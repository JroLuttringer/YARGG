...
def plot_road(c1, c2, m):
    ...
    with open(res, 'r') as f:
        ...
        delay = int(dist /LIGHT_SPEED*10000)
...
print()
d = delays["Frankfurt"]["Genève"] + delays["Genève"]["Milan"] + delays["Milan"]["Vienne"]

print("FRANK -  GEN " + str(delays["Frankfurt"]["Genève"]))

print("FRANK - MILAN " + str(delays["Frankfurt"]["Genève"] + delays["Genève"]["Milan"]))

print("FRANK -  BUDAPEST " + str(delays["Frankfurt"]["Budapest"]))

print("FRANK -  VIENNA (RED) " + str(delays["Frankfurt"]["Vienne"]))

print("FRANK -  VIENNA (GREEN) " + str(delays["Frankfurt"]["Genève"] + delays["Genève"]["Milan"] + delays["Milan"]["Vienne"]))

print("Gen - Vie " + str(delays["Genève"]["Milan"] + delays["Milan"]["Vienne"]))

print("Gen - Budapest " + str(delays["Genève"]["Frankfurt"] + delays["Frankfurt"]["Budapest"]))

print("Gen - Mil " + str(delays["Genève"]["Milan"] ))

print("Mil - Vie " + str(delays["Milan"]["Vienne"]))

print("Mil - Budapest" + str(delays["Milan"]["Vienne"] + delays["Vienne"]["Budapest"]))

print("Bud - Vie" + str(delays["Budapest"]["Vienne"]))



# print("Green = {}j km = {} ms".format(d, d/LIGHT_SPEED*1000))
# print("F-G = {}, G-M = {}, M-V = {}".format(dists["Frankfurt"]["Genève"]/LIGHT_SPEED*1000, dists["Genève"]["Milan"]/LIGHT_SPEED*1000,dists["Vienne"]["Milan"]/LIGHT_SPEED*1000 ))

print()
d = dists["Frankfurt"]["Budapest"] + dists["Budapest"]["Vienne"] 
print("Orange = {}j km = {} ms".format(d, d/LIGHT_SPEED*1000))
print("F-B = {}, B-V = {}".format(dists["Frankfurt"]["Budapest"]/LIGHT_SPEED*1000, dists["Budapest"]["Vienne"]/LIGHT_SPEED*1000 ))
